       ...
       <div class="modal-body" style="padding:40px 50px;">
         <form role="form">
           <div class="form-group">
             ...
             <input type="text" class="form-control" id="usrname" placeholder="Matrícula">
           </div>
           <div class="form-group">
             <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Contraseña</label>
             <input type="text" class="form-control" id="psw" placeholder="Contraseña">
           </div>
           <!--<div class="form-group">
             <label for="psw"><span class="glyphicon glyphicon-refresh"></span>Captcha:</label>
             <input type="text" class="form-control" id="psw" placeholder="Introduce el captcha">
           </div>-->
