...
if (isset($elementos_imagen['id_file'])) {//Valida que existe la imagen del usuario
    ...
    $eliminar_imagen = '<button class="btn btn-primary btn-label-right" type="button"
            id="elimina_foto" >' .
            $string_value["btn_eliminar_imagen"]
            . '</button>';
}
?>
...
<div class="text-center">
    <div id="<?php echo $div_respuesta; ?>" ></div>

    <label><?php echo $string_value['lbl_cargar_imagen'];?></label><input type="file" id="file-input" accept="image/jpg, image/png">
    ...
    <div id="result" class="result">
        <img src="<?php echo $ruta_imagen_perfil; ?>" class="img-responsive">
    </div>
