...
<div id="myCarousel<?php echo $id_seccion; ?>">
    ...
    <div >
            ...
            ?>
                        <th> <input type="radio" id="radio_si_general" name="radio_general_<?php echo $id_seccion?>" data-seccion="<?php echo $id_seccion?>" onclick="selecciona_todo(this);" value="si"><label>Si a todo </label></th>
                        <th> <input type="radio" id="radio_no_general" name="radio_general_<?php echo $id_seccion?>" data-seccion="<?php echo $id_seccion?>" onclick="selecciona_todo(this);" value="no"><label>No a todo </label></th>
