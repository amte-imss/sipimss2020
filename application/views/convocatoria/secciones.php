                    ...
                    <div class="panel-group">
                        <div class="panel panel-default">
                            ...
                            <div id="collapse1" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <?php
                                    echo form_open('convocatoria/get_secciones/' . $convocatoria['id_convocatoria'], array('id' => 'form_convocatoria_n1'));
                                    ?>
                    ...
                    <div class="panel-group">
                        <div class="panel panel-default">
                            ...
                            <div id="collapse2" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <?php
                                    echo form_open('convocatoria/get_secciones/' . $convocatoria['id_convocatoria'], array('id' => 'form_convocatoria_n2'));
                                    ?>
