...
//        deleteConfirm: "¿Deseas eliminar este registro?",
        ...
        controller: {
          loadData: function (filter) {
              ...
              $.ajax({
                  type: "POST",
                  url: site_url + url_ctr + "/datos_reporte_posgrado/",
                  data: filter,
                  dataType: "json"
        ...
        fields: [
            ...
            {name: 'nom_unidad', title: "Unidad", type: "text", visible:true, width:"200"},
            {name: 'nom_tipo_unidad', title: "Tipo unidad", type: "text", visible:true},            
            {name: 'clave_delegacional', title: "OOAD", type: "text"/*"select", items: delegaciones,valueField: "clave_delegacional"*/, textField: "nombre",  visible:true},
            ...
            {name: 'id_status_validacion', title: "Estado validación", type: "text"/*"select", items:estados_validacion, valueField: "id"*/, textField: "label", visible:true},
            ...
            {name:'informacion_posgrado', type: "text", title: "Datos formulario posgrado", visible:true, width:"1200",
...
function obtener_cabeceras() {
    var arr_header = {
        ...
        informacion_posgrado: 'Datos formulario posgrado'        
    }
